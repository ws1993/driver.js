...
description: "Customize the Driver.js overlay with the overlayColor and overlayOpacity options. Change the backdrop color and dimming to match your product's look."
groupTitle: "Examples"
sort: 5
---
