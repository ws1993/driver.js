...
description: "Ask users to confirm before they leave a Driver.js tour. Use the onDestroyStarted hook to show a confirmation dialog or run custom logic on exit."
groupTitle: "Examples"
sort: 3
---
