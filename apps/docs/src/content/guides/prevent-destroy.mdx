...
description: "Stop users from exiting a Driver.js tour early. Set the allowClose option to false to keep the tour open until they reach and complete the final step."
groupTitle: "Examples"
sort: 3
---
