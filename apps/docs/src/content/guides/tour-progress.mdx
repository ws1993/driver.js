---
title: "Tour Progress"
description: "Show tour progress in Driver.js with the showProgress option. Display a step counter like 1 of 5 and customize the progressText template to fit your UI."
groupTitle: "Examples"
sort: 2
---
