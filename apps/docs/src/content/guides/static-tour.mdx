---
title: "Static Tour"
description: "Create a static, non-animated product tour with Driver.js. Set the animate option to false to jump instantly between steps with no transition effects."
groupTitle: "Examples"
sort: 2
---
